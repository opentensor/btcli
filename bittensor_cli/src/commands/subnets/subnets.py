    ...
    if not reuse_last:
        ...
        for uid in metagraph.uids:
            ...
            row = [
                ...
                str(metagraph.block[0] - metagraph.last_update[uid]),
                str(metagraph.active[uid]),
                (
                    ep.ip + ":" + str(ep.port)
                    if ep.is_serving
            ...
            db_row = [
                ...
                metagraph.block[0] - metagraph.last_update[uid],
                metagraph.active[uid],
        ...
        metadata_info = {
            ...
            "block": str(metagraph.block[0]),
            "N": f"{sum(metagraph.active)}/{metagraph.n[0]}",
            "N0": str(sum(metagraph.active)),
            "N1": str(metagraph.n[0]),
