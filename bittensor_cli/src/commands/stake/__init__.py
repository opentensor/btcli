...
async def select_delegate(subtensor: "SubtensorInterface", netuid: int):
    ...
    registered_delegate_info: Optional[DelegatesDetails] = await subtensor.get_delegate_identities()
    ...
    while True:
        ...
        user_input: str = rich.prompt.Prompt.ask(
    ...
    if selected_idx is None:
        raise IndexError("You must make a selection.")
    else:
