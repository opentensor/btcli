...
def test_stake_slippage_protection(local_chain, wallet_setup):
    """
    Test slippage protection options for swap command.
    ...
    """
    print("Testing slippage protection for swap command 🧪")
    ...
    print(
        "✅ TEST 3: Swap with slippage protection and partial stake completed successfully"
    )

    print("✅ Passed all slippage protection tests for swap command")
